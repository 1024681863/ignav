...
EXPORT opt_t insopts[]={
    ...
    {"ins-SINS_RotAngle_IMU1",   1, (void *)&prcopt_.insopt.SINS_RotAngle_IMU[0], "" },
    {"ins-SINS_RotAngle_IMU2",   1, (void *)&prcopt_.insopt.SINS_RotAngle_IMU[1], "" },
    {"ins-SINS_RotAngle_IMU3",   1, (void *)&prcopt_.insopt.SINS_RotAngle_IMU[2], "" },
